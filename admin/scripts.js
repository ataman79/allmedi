...
jQuery(document).ready(function() {
	...
	// overrides
	var elements = ['layout_override', 'tools_for_pages', 'suffix_override', 'module_override'/*, 'menu_override'*/, 'mootools_for_pages', 'sidebar_width_for_pages', 'inset_width_for_pages', 'inner_inset_width_for_pages'];
	...
	function getUpdates() {
		...
		var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_news_j30';
